...
class GleanToolInput(BaseModel):
    """Input schema for Glean tool.
...
class GleanTool(BaseTool):  # type: ignore[override]
    """Glean tool.

    Setup:
        # TODO: Replace with relevant packages, env vars.
        Install ``langchain-glean`` and set environment variable ``GLEAN_API_KEY``.
    ...
    args_schema: Type[BaseModel] = GleanToolInput
